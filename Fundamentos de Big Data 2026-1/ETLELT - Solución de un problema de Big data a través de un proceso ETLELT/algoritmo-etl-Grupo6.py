...
def cargarDepartamento(conn, cursor, 
    ...
    print(sufijo, id_departamento, nombre_dep, codigo_departamento, codigo_region, cantidad)
     ...
     # --- INICIO DE LA MODIFICACIÓN PARA REGIÓN ---
    # Este comando busca todas las ventas de este departamento y les asigna su región
    sql_valorizar_region = "UPDATE operaciones SET id_region = %s WHERE id_departamento = %s;"
    cursor.execute(sql_valorizar_region, (codigo_region, id_departamento))
